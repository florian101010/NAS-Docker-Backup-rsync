...
- [⚡ Schnellstart](#-schnellstart-5-minuten)
- [📊 Verwendungsbeispiele](#-verwendungsbeispiele)
- [📖 Konfiguration](#-detaillierte-konfiguration)
- [🔄 Automatisierung](#-automatisierung-mit-cron)
- [🛡️ Sicherheit](#️-sicherheitsfeatures)
- [📊 Überwachung](#-überwachung--logging)
- [🔧 Fehlerbehebung](#-fehlerbehebung)
- [🔐 Verschlüsselung](#-backup-verschlüsselung)
- [🤝 Mitwirken](#-mitwirken)
