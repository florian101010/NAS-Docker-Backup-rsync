...
- [🐳 NAS - Docker Backup Script (rsync)](#-nas---docker-backup-script-rsync)
  ...
  - [⚡ Quick Start (5 Minutes)](#-quick-start-5-minutes)
    - [1️⃣ One-Line Installation with System Check](#1️⃣-one-line-installation-with-system-check)
    - [2️⃣ Configure Your Paths](#2️⃣-configure-your-paths)
    - [3️⃣ Test \& Run](#3️⃣-test--run)
    - [4️⃣ Next Steps Checklist](#4️⃣-next-steps-checklist)
  - [🌍 Language Support](#-language-support)
  - [📊 Usage Examples](#-usage-examples)
  - [📖 Detailed Configuration](#-detailed-configuration)
    - [Command Line Options](#command-line-options)
  - [🔄 Automation with Cron](#-automation-with-cron)
    - [Safe Parallel Cron Examples (v3.5.1+)](#safe-parallel-cron-examples-v351)
  ...
  - [📊 Monitoring \& Logging](#-monitoring--logging)
    - [Log Files](#log-files)
    - [Container Status Indicators](#container-status-indicators)
  - [🔧 Troubleshooting](#-troubleshooting)
    - [Common Issues](#common-issues)
    - [Dependency Validation](#dependency-validation)
  - [🔐 Backup Encryption](#-backup-encryption)
    - [Quick Encryption Setup](#quick-encryption-setup)
